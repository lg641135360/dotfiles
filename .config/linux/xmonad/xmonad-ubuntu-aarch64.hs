...
myStartupHook = do
    ...
    spawn "xinput set-prop 10 'libinput Natural Scrolling Enabled' 1"
    spawn "xinput set-prop 10 'libinput Tapping Enabled' 1"
    spawn "xinput set-prop 10 'libinput Click Method Enabled' 1 0"
    spawn "xinput set-prop 10 'libinput Disable While Typing Enabled' 1"
    spawn "xrandr --output eDP-1 --mode 0x4b"
    spawn "killall gestures 2>/dev/null; sleep 0.1; gestures start"
