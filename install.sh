...
linux_configs=(
    ...
    "|.config/scripts/corplink-service|~/.config/scripts/corplink-service|Corplink temporary service manager"
...
linux_wayland_configs=(
    ...
    "|.config/scripts/dingtalk-wayland|~/.config/scripts/dingtalk-wayland|DingTalk troubleshooting script"
    ...
    "|.config/scripts/chatgpt-wayland|~/.config/scripts/chatgpt-wayland|Wayland ChatGPT script"
